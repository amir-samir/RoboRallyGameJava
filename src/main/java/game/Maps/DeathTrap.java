...
//Frage an die maps:
// 1. register anzahl von maps sieht man fast gar nicht.
// 2. hat EnergySpace eigentlich auch orientations? wofuer braucht man es?
...
public class DeathTrap {
    ...
    public DeathTrap() {
        ...
        map[1][1].add(new PushPanel("2A", "bottom", new int[]{1,2,3}));
        ...
        map[1][8].add(new PushPanel("2A", "bottom", new int[]{1,2,3}));
        ...
        map[3][4].add(new PushPanel("2A", "top", new int[]{2,3}));
        ...
        map[4][6].add(new PushPanel("2A", "bottom", new int[]{2,3}));
        ...
        map[5][3].add(new PushPanel("2A", "top", new int[]{2,3}));
        map[5][4].add(new PushPanel("2A", "bottom", new int[]{2,3}));
        ...
        map[8][1].add(new PushPanel("2A", "right", new int[]{2,4}));
        ...
        map[8][8].add(new PushPanel("2A", "top", new int[]{2,4}));
