...
public class DeathTrap extends Board {
    ...
    public DeathTrap() {
        ...
        map[1][0].add(new CheckPoint("2A", 5));
        ...
        map[2][8].add(new CheckPoint("2A", 4));
        ...
        map[4][4].add(new CheckPoint("2A", 2));
        ...
        map[7][1].add(new CheckPoint("2A", 1));
        ...
        map[8][7].add(new CheckPoint("2A", 3));
